(ns marketentry.store
  "SSoT for the Republic of Guinea (GIN) market-entry compliance actor,
...
(defn demo-data
  ...
  `:prior-armp-pecuniary-sanction?` / `:armp-sanction-amount` /
  `:armp-sanction-base-amount` are ground truth for the flagship
  TWO-SIDED PERCENTAGE-RANGE VALIDATION check (Code des Marchés Publics
  Art. 159 -- does a declared prior ARMP pecuniary sanction stay within
  the 1%-2% statutory range of its declared base amount?);
  `:requires-nifp?` / `:nifp-verified?` are ground truth for the
  conditional Direction Générale des Impôts (DGI) NIFP check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Conakry Négoce SARL" :procurement-channel "ARMP (armpguinee.org) tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-armp-pecuniary-sanction? false
             :requires-nifp? true :nifp-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GIN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :procurement-channel "ARMP (armpguinee.org) tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-armp-pecuniary-sanction? false
             :requires-nifp? true :nifp-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Kaloum Logistique SA" :procurement-channel "ARMP (armpguinee.org) tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "GIN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Fouta Djallon Travaux Publics SARL" :procurement-channel "ARMP (armpguinee.org) tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-armp-pecuniary-sanction? true :armp-sanction-amount 50000 :armp-sanction-base-amount 1000000
             :requires-nifp? true :nifp-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GIN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Niger Import-Export SARL" :procurement-channel "ARMP (armpguinee.org) tender notice"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :prior-armp-pecuniary-sanction? false
             :requires-nifp? true :nifp-verified? false
             :drafted? false :submitted? false
             :jurisdiction "GIN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Alpha Construction et Cie" :procurement-channel "ARMP (armpguinee.org) tender notice"
             :base-fee 400000 :monthly-rate 25000 :monitoring-months 6
             :claimed-fee 550000.0
             :prior-armp-pecuniary-sanction? true :armp-sanction-amount 15000 :armp-sanction-base-amount 1000000
             :requires-nifp? true :nifp-verified? true
             :drafted? false :submitted? false
             :jurisdiction "GIN" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator procurement-channel base-fee monthly-rate monitoring-months claimed-fee
                               prior-armp-pecuniary-sanction? armp-sanction-amount armp-sanction-base-amount
                               requires-nifp? nifp-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? prior-armp-pecuniary-sanction?)            (assoc :engagement/prior-armp-pecuniary-sanction? prior-armp-pecuniary-sanction?)
    armp-sanction-amount                              (assoc :engagement/armp-sanction-amount armp-sanction-amount)
    armp-sanction-base-amount                         (assoc :engagement/armp-sanction-base-amount armp-sanction-base-amount)
    (some? requires-nifp?)                            (assoc :engagement/requires-nifp? requires-nifp?)
    (some? nifp-verified?)                            (assoc :engagement/nifp-verified? nifp-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/procurement-channel :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/prior-armp-pecuniary-sanction? :engagement/armp-sanction-amount :engagement/armp-sanction-base-amount
   :engagement/requires-nifp? :engagement/nifp-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :procurement-channel (:engagement/procurement-channel m)
     ...
     :prior-armp-pecuniary-sanction? (boolean (:engagement/prior-armp-pecuniary-sanction? m))
     :armp-sanction-amount (:engagement/armp-sanction-amount m)
     :armp-sanction-base-amount (:engagement/armp-sanction-base-amount m)
     :requires-nifp? (boolean (:engagement/requires-nifp? m))
     :nifp-verified? (boolean (:engagement/nifp-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-gin"})
